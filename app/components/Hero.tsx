        ...
        <div className="relative z-10 mx-auto w-full max-w-[920px] text-center">
          ...
          <div className="mt-8 flex justify-center sm:mt-10 lg:mt-12">
            <a
              ...
              className="inline-flex min-h-[52px] w-full max-w-[320px] items-center justify-center rounded-[6px] bg-[#4141f5] px-6 py-3 text-center text-[18px] font-bold leading-[1.4] text-white transition-all duration-200 hover:-translate-y-0.5 hover:opacity-90 sm:w-auto sm:max-w-none sm:px-7"
            >
