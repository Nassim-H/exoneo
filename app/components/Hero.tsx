  ...
  return (
    <section className="relative isolate overflow-hidden bg-white text-[#040325]">
      <div className="relative mx-auto flex min-h-[calc(100vh-76px)] w-full max-w-[1500px] items-center px-5 py-14 sm:px-8 sm:py-16 lg:px-10">
        ...
        >
          <img src="/VectorVert.svg" alt="" width={121} height={122} className="h-auto w-[58px] sm:w-[66px] lg:w-[84px]" />
        </motion.div>
        ...
        >
          <img src="/VectorRose.svg" alt="" width={120} height={122} className="h-auto w-[58px] sm:w-[66px] lg:w-[86px]" />
        </motion.div>
        ...
        >
          <img src="/VectorBleu.svg" alt="" width={121} height={122} className="h-auto w-[58px] sm:w-[66px] lg:w-[86px]" />
        </motion.div>
        ...
        >
          <img src="/VectorJaune.svg" alt="" width={121} height={122} className="h-auto w-[58px] sm:w-[66px] lg:w-[86px]" />
        </motion.div>
